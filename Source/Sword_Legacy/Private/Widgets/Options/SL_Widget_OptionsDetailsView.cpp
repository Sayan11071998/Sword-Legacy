...
void USL_Widget_OptionsDetailsView::UpdateDetailsViewInfo(TObjectPtr<USL_ListDataObject_Base> InDataObject,
...
void USL_Widget_OptionsDetailsView::NativeOnInitialized()
{
