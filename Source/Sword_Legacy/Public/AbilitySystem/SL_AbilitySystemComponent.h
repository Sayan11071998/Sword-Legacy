...
public:
	...
	void GrantPlayerWeaponAbilities(const TArray<FSL_PlayerAbilitySet>& InDefaultWeaponAbilities, const TArray<FSL_PlayerSpecialAbilitySet>& InSpecialWeaponAbilities, int32 ApplyLevel, TArray<FGameplayAbilitySpecHandle>& OutGrantedAbilitySpecHandles);
